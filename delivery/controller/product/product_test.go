...
func TestCreateProduct(t *testing.T) {
	t.Run("1. Error create product - can't get image", func(t *testing.T) {
		e := echo.New()
		e.Validator = &CustomValidator{validator: validator.New()}

		requestBody, _ := json.Marshal(CreateProductRequestFormat{
			Name: "Whiskas", Price: 100000, Stock: 100, StoreID: 1, CategoryID: 2,
		})
	...
	t.Run("2. Error create product - the image isn't in jpg/png format", func(t *testing.T) {
		e := echo.New()
		e.Validator = &CustomValidator{validator: validator.New()}
	...
	t.Run("3. Error create product - can't create product", func(t *testing.T) {
		e := echo.New()
		e.Validator = &CustomValidator{validator: validator.New()}
	...
	t.Run("4. Success create product 1 - non grooming product", func(t *testing.T) {
		e := echo.New()
		e.Validator = &CustomValidator{validator: validator.New()}
	...
	t.Run("5. Success create product 2 - grooming product", func(t *testing.T) {
		e := echo.New()
		e.Validator = &CustomValidator{validator: validator.New()}
...
func TestGetAllProduct(t *testing.T) {
	t.Run("1. Error get all product", func(t *testing.T) {
		e := echo.New()
	...
	t.Run("2. Success get all product", func(t *testing.T) {
		e := echo.New()
...
func TestGetProductByID(t *testing.T) {
	t.Run("1. Error get product - product id not found", func(t *testing.T) {
		e := echo.New()
	...
	t.Run("2. Success get product", func(t *testing.T) {
		e := echo.New()
...
func TestGetStockHistory(t *testing.T) {
	...
	t.Run("2. Success get stock history", func(t *testing.T) {
		e := echo.New()
...
func TestGetProductStoreID(t *testing.T) {
	t.Run("1. Error get all product by store id - store id not found", func(t *testing.T) {
		e := echo.New()
	...
	t.Run("2. Success get all product by store id", func(t *testing.T) {
		e := echo.New()
...
func TestUpdateProduct(t *testing.T) {
	t.Run("1. Error create product - the image isn't in jpg/png format", func(t *testing.T) {
		e := echo.New()
		e.Validator = &CustomValidator{validator: validator.New()}
	...
	t.Run("2. Error create product - can't create product", func(t *testing.T) {
		e := echo.New()
		e.Validator = &CustomValidator{validator: validator.New()}
...
func (mc mockProductRepository) GetAllProduct() ([]entity.Product, error) {
	return []entity.Product{
		{ID: 2, Name: "Whiskas", Price: 100000, Stock: 100, StoreID: 1, CategoryID: 2}}, nil
}
...
func (mc mockProductRepository) CreateProduct(userID int, newProduct entity.Product) (entity.Product, error) {
	if newProduct.CategoryID == 1 {
		return entity.Product{
			ID: 1, Name: "Grooming", Price: 100000, StoreID: 1, CategoryID: 1}, nil
	}
	return entity.Product{
		ID: 2, Name: "Whiskas", Price: 100000, Stock: 100, StoreID: 1, CategoryID: 2}, nil
}
...
func (mc mockProductRepository) UpdateProduct(productID int, updatedProduct entity.Product) (entity.Product, error) {
	if updatedProduct.CategoryID == 1 {
		return entity.Product{
			ID: 1, Name: "Grooming new", Price: 100000, StoreID: 1, CategoryID: 1}, nil
	}
	return entity.Product{
		ID: 2, Name: "Whiskas new", Price: 100000, Stock: 100, StoreID: 1, CategoryID: 2}, nil
}
...
func (mc mockProductRepository) GetStockHistory(productID int) ([]entity.StockHistory, error) {
	return []entity.StockHistory{
		{ID: 1, ProductID: 2, Stock: 100}}, nil
}
...
func (mfc mockFalseProductRepository) GetAllProduct() ([]entity.Product, error) {
	return []entity.Product{
		{ID: 0, Name: "", Price: 0, Stock: 0, StoreID: 0, CategoryID: 0}}, errors.New("can't get product data")
}
...
func (mfc mockFalseProductRepository) CreateProduct(userID int, newProduct entity.Product) (entity.Product, error) {
	return entity.Product{
		ID: 0, Name: "", Price: 0, Stock: 0, StoreID: 0, CategoryID: 0}, errors.New("can't create product data")
}

func (mfc mockFalseProductRepository) UpdateProduct(productID int, updatedProduct entity.Product) (entity.Product, error) {
	return entity.Product{
		ID: 0, Name: "", Price: 0, Stock: 0, StoreID: 0, CategoryID: 0}, errors.New("can't update product data")
}
...
func (mfc mockFalseProductRepository) GetStockHistory(productID int) ([]entity.StockHistory, error) {
	return []entity.StockHistory{
		{ID: 0, ProductID: 0, Stock: 0}}, errors.New("can't get stock product history data")
}
